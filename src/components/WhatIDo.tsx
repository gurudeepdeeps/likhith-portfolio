        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                I turn raw footage into cinematic, story-driven videos — every cut, color, and sound designed to captivate.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                I craft platform-ready content for YouTube, Reels, and brands — from concept to final publish.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
                <div className="what-tags">Adobe Premiere Pro</div>
